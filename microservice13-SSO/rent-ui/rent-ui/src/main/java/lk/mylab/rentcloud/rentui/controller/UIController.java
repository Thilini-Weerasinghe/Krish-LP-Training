package lk.mylab.rentcloud.rentui.controller;

import com.thilini.rentcloud.commons.model.Customer;
import lk.mylab.rentcloud.rentui.config.AccessToken;
...
public class UIController extends WebSecurityConfigurerAdapter {
    ...
    public String loadCustomers(Model model){
        ...
        try{
            ResponseEntity <Customer[]> responseEntity = restTemplate.exchange("http://localhost:8191/services/customers", HttpMethod.GET,customerHttpEntity,Customer[].class);
